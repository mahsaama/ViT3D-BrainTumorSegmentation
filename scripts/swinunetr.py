...
if ds == "2020":
    ...
    t1_list = sorted(glob.glob(data_dir + "*/*t1.nii.gz"))[348:]
    t2_list = sorted(glob.glob(data_dir + "*/*t2.nii.gz"))[348:]
    t1ce_list = sorted(glob.glob(data_dir + "*/*t1ce.nii.gz"))[348:]
    flair_list = sorted(glob.glob(data_dir + "*/*flair.nii.gz"))[348:]
    seg_list = sorted(glob.glob(data_dir + "*/*seg.nii.gz"))[348:]
