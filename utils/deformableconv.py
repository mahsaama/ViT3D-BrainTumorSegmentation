...
class DeformConv3d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=3, stride=1, padding=1, bias=False, dilation=1, groups=1):
        ...
        self.offset_conv_kernel = nn.Conv3d(in_channels, N * 3, kernel_size=self.kernel_size, padding=padding, bias=bias)
